        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Ubah keterangan alamat pada tampilan website dengan cara tekan <b>UBAH<b> </p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo ucfirst($data2["alamat"]) ?></td>
                                                <td>
                                                    <a href="edit_alamat.php?id=<?php echo $data2["id"] ?>" class="btn btn-primary">Ubah</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
