                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Judul Berita">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Isi</label>
                            <textarea name="isi" required cols="30" rows="10" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Gambar</label>
                            <input type="file" required class="form-control" name="gambar" accept=".jpg,.jpeg,.png,.gif">
                        </div>
                    ...
                    if (isset($_POST["add"])) {
                        ...
                        $query = mysqli_query($koneksi, "INSERT INTO berita VALUES (NULL, '$_POST[judul]','$_POST[isi]','$_POST[author]', now(),'$nama')");
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Jika sudah yakin, tekan tombol <b>KELUAR<b></div>
