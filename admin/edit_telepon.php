        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <?php
                    $data = mysqli_query($koneksi, "SELECT * FROM telepon WHERE id='$_GET[id]'");
                    ...
                    ?>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="telepon" required cols="30" rows="10" class="form-control"><?php echo $data2['telepon'] ?></textarea>
                            </div>
                    ...
                    if (isset($_POST["edit"])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE telepon SET telepon='$_POST[telepon]' WHERE id='$_GET[id]'");

                        move_uploaded_file($_FILES['gambar']['tmp_name'], "../src/images/" . $nama);
                        if ($query) {
                            echo "<script>location='telepon.php';</script>";
                        }
                    }
                    ?>
