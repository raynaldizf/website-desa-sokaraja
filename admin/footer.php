        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Ubah keterangan footer pada tampilan website dengan cara tekan <b>UBAH<b> </p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo ucfirst($data2["email"]) ?></td>
                                                <td>
                                                    <a href="edit_email.php?id=<?php echo $data2["id"] ?>" class="btn btn-primary">Ubah</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
