            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required value="<?php echo $data2['judul'] ?>" name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                            </div>
                            <div class="form-group">
                    ...
                    if (isset($_POST["edit"])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE berita SET judul='$_POST[judul]', isi='$_POST[isi]', gambar='$nama' WHERE id='$_GET[id]'");
