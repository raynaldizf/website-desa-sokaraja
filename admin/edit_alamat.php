        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <?php
                    $data = mysqli_query($koneksi, "SELECT * FROM alamat WHERE id='$_GET[id]'");
                    ...
                    ?>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" required cols="30" rows="10" class="form-control"><?php echo $data2['alamat'] ?></textarea>
                            </div>
                    ...
                    if (isset($_POST["edit"])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE alamat SET alamat='$_POST[alamat]' WHERE id='$_GET[id]'");
