        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <?php
                    $data = mysqli_query($koneksi, "SELECT * FROM email WHERE id='$_GET[id]'");
                    ...
                    ?>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="email" required cols="30" rows="10" class="form-control"><?php echo $data2['email'] ?></textarea>
                            </div>
                    ...
                    if (isset($_POST["edit"])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE email SET email='$_POST[email]' WHERE id='$_GET[id]'");

                        move_uploaded_file($_FILES['gambar']['tmp_name'], "../src/images/" . $nama);
                        if ($query) {
                            echo "<script>location='email.php';</script>";
                        }
                    }
                    ?>
