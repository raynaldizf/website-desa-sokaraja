        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Nomor Telepon</h1>
                    <p class="mb-4">Ubah keterangan nomor telepon pada tampilan website dengan cara tekan <b>UBAH<b> </p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo ucfirst($data2["telepon"]) ?></td>
                                                <td>
                                                    <a href="edit_telepon.php?id=<?php echo $data2["id"] ?>" class="btn btn-primary">Ubah</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
